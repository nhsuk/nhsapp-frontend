...
Hubs act as the primary navigation structure of the NHS App, helping users access the services and information they need.

There are three hubs: Home, Messages and Profile. From these hubs, users can follow links to start various journeys or move deeper into lower menus called [sub-hubs](/docs/patterns/sub-hub-page.md).
...
## Making changes to the structure of a hub

Hubs form the core structure of the NHS App. Because of their foundational role in how users navigate and understand the app, these screens are carefully maintained and protected from frequent or big changes.

The Navigation and Onboarding team is responsible for the structure and content of all hubs and have final say on changes. Any proposed changes to hubs must be designed, researched and approved by this team.

If you need to add a new journey or service, or believe a change to a hub would improve the user experience, you should contact the IA and Navigation team early in your design process.
