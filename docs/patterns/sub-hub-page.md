...
title: Sub-hubs
description: Sub-hubs are the second layer of menu screens in the NHS App. They are positioned one level down from hubs.
backlogID: 249
order: 3
tags:
  - screen
...
Sub-hubs group closely related series of links. They reveal information to users in a way that lets them decide where to go next, without being overwhelmed by too many options or distracted by irrelevant options on hubs.
...
Sub-headings should also be used if a sub-hub has more than 5 card links. Research shows that users can be overwhelmed by long lists of card links, which clear sub-sections can alleviate.

### Card links

[Card links](/docs/components/card-links.md) on sub-hubs can take users to deeper layers of menu screens or the start of services and other journeys. Some card link labels in sub-hubs or deeper menu screens may be supported by a short description, if a user need for one has been uncovered.
...
In our research, people were able to use sub-hubs to complete tasks and they understood where they were in the app. Some users were not aware that they could scroll to view the bottom of the sub-hubs. However, this may have been influenced by our testing with a prototype rather than users' own devices.
