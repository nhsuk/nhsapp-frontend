...
| `actiopnLabel`      | The label for the action, shown in bold in the accent colour                                                                   |
...
| `accessibilityHint` | Optional. A short description of what happens on tap. This is not visible but is read out by VoiceOver after the banner's text |
